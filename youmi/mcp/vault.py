...
from youmi.mcp.models import ToolContextTier, ToolEntry, ToolSearchResult
...
# 向后兼容 re-export
# ---------------------------------------------------------------------------
# ToolContextTier, ToolEntry, ToolSearchResult 已移至 youmi.mcp.models
# 此处通过上方 import 保持 from youmi.mcp.vault import XXX 仍然可用
...
class ToolVault:
    ...
    def __contains__(self, tool_name: str) -> bool:
        """支持 ``tool_name in vault`` 检查工具是否已注册"""
